...
class MFMPDepthNet(NetworkBase):
    ...
    def __init__(self, image_extractor_name, image_extractor_hparams, lidar_extractor_name, lidar_extractor_hparams,
        ...
        self.encoder = select_image_extractor(image_extractor_name, activation_cls, **image_extractor_hparams)

        self.lidar_encoder = select_lidar_extractor(lidar_extractor_name, activation_cls, **lidar_extractor_hparams)
