...
NAME=AGcat-mult-sig_scratch_photo_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
...
NAME=AGcat-mult-sig_scratch_photo+vel_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_scratch_D_hinted_reproj_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_scratch_D_hinted_berhu_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_scratch_D_hinted_l1_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_photo_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_photo+vel_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_reproj_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_hinted_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_hinted_reproj_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_hinted_berhu_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_hinted_l1_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_scratch_mish_photo_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
...
NAME=AGcat-mult-sig_pretrained_D_mish_photo_ranger_cosannealstart=25e-2_lr=9e-5_bs=8_shufl_resnet18_`date +"%m%d_%H%M%S"`; \
python ./submit_job.py -n $NAME --gpumem 16000 \
-pf ../configs/projects/monocular_frontcam_depth_argo.yml \
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_frontcam.yml \
