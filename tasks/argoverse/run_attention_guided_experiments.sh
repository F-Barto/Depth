...
-po "experiment_name=$NAME" \
-mf ../configs/experiments/argoverse/self_supervised_randcam.yml \
-mo "model=attention_guiding_resnet18 model.tri_checkpoint_path='/home/clear/fbartocc/depth_project/Depth/weights/ResNet18_MR_selfsup_D.ckpt' losses=semi_supervised dataloaders.train.batch_size=1 dataloaders.val.batch_size=5 dataloaders.test.batch_size=5 trainer.accumulate_grad_batches=8"
